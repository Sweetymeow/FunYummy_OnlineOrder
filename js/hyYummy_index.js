...
// Rush Order Variables
var d_names = new Array("Sunday", "Monday", "Tuesday",
"Wednesday", "Thursday", "Friday", "Saturday");
var bannerImgs = new Array("banner1.jpg","banner2.jpg","banner3.jpg","banner4.jpg","banner5.jpg");
var menu = ["Menu1 : Sweet Shrimp / Mapo Tofu / Yangzhou Fried Rice / Red bean soup / apple / Cock ","Menu2 : Chicken with cashew nuts / Chicken with snow pea pods / Chicken with almond ding / Boneless Chicken","Menu3 : Pepper Steak with onion / Beef with snow pea pods / Beef with chinese vegetables / Beef with mixed chinese","Menu 4: Beef with curry sauce / Beef with tomato & pepper / Beef with black bean sauce" , "Menu5 : Beef with curry sauce / Beef with tomato & pepper / Beef with black bean sauce"]; 
...
//	var menutext = $('<p id="ordermenu"><em>Menu: </em> this part is menu. </p>');
	...
	if($.cookie('IST')){// Read Cookie
		rushOrderList[0] = $.cookie('IST');
		// test of cookie
		$('section#orderSum').append('<div><p> This is test of cookie: ' + rushOrderList[0] + '</p></div>');
	}
/*
	// 可以改进
...
*/	
	...
	// fill next deliverable day's date to each order detail table
	$('div.orderDetail').each(function(i) {
		var nextDateStr = printDate(nextDvlDate);
		// fill next delivery day date
		$(this).find('th#dvl_date').text(nextDateStr);
		// fill order number for each meal
